...
<head>
    ...
    <link href="<?php echo base_url(); ?>formwizard/css/bootstrap.min.css" rel="stylesheet"/>
    <link href="<?php echo base_url(); ?>formwizard/css/font-awesome.min.css" rel="stylesheet"/>
    <link href="<?php echo base_url(); ?>formwizard/style.css" rel="stylesheet"/>
</head>
<body>
  <script src="<?php echo base_url();?>formwizard/js/jquery.min.js"></script>
    <script src="<?php echo base_url();?>formwizard/js/popper.min.js"></script>
    <script src="<?php echo base_url();?>formwizard/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url();?>formwizard/script.js"></script>  
    <div class="container">
